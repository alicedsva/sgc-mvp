  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          // bg-popover/text-popover-foreground nunca geram CSS neste projeto
          // (mesmo problema documentado em ui/popover.tsx e ui/command.tsx —
          // theme.css define os tokens shadcn fora de um bloco @theme do
          // Tailwind v4) — cores concretas aqui, nunca os tokens semânticos.
...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        // Mesma correção de tokens shadcn quebrados (ver DropdownMenuContent
        // acima): focus:bg-accent/text-destructive/text-muted-foreground
        // nunca geram CSS aqui — substituídos por cores concretas. Ação
        // destrutiva = ícone + texto em text-red-600 (mesmo tom já usado
        // pela variant="danger" das ações em linha de Table.tsx), hover
        // bg-red-50 — ver 02-design-system.md > Tabelas > Menu de ações.
